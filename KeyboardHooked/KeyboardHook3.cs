...
namespace HongliangSoft.Utilities.Gui
{
    ...
    public class KeyboardHook : Component
    {
        ...
        public KeyboardHook()
        {
            ...
            this.hook = SetWindowsHookEx(WH_KEYBOARD_LL, callback, GetModuleHandle(Process.GetCurrentProcess().MainModule.ModuleName), 0);//SetWindowsHookEx(KeyboardHookType, callback, module, 0);
        }
        ///<summary>
